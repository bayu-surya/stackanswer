...
import com.stackanswer.retrofit.ApiConfig;
import com.stackanswer.retrofit.listMoviePopuler.ListMoviePopularResponse;
import com.stackanswer.retrofit.listMoviePopuler.ResultsItem;
...
public class JsonHelper {
    ...
    public void loadShow(String language, String page, final ShowRemoteDataSource.CallbackShow arrayCallback){
        ...
        client.enqueue(new Callback<ListShowPopularResponse>() {
            ...
            public void onResponse(@NotNull Call<ListShowPopularResponse> call, @NotNull Response<ListShowPopularResponse> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        List<com.stackanswer.retrofit.listShowPopular.ResultsItem> resultsItem = response.body().getResults();
                        for (int i=0;i<resultsItem.size();i++){
                            Show show = new Show();
    ...
    public void loadDetailShow(String language, String page, final DetailShowRemoteDataSource.CallbackDetailShow arrayCallback){
        ...
        Call<com.stackanswer.retrofit.detailshow.Response> client = ApiConfig.getApiService().getDetailShowPopuler(page, API_KEY_MOVIEDB, language);
        client.enqueue(new Callback<com.stackanswer.retrofit.detailshow.Response>() {
            @Override
            public void onResponse(@NotNull Call<com.stackanswer.retrofit.detailshow.Response> call, @NotNull Response<com.stackanswer.retrofit.detailshow.Response> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        com.stackanswer.retrofit.detailshow.Response data = response.body();
            ...
            @Override
            public void onFailure(@NotNull Call<com.stackanswer.retrofit.detailshow.Response> call, @NotNull Throwable t) {
                Log.e(TAG, "onFailure: " + t.getMessage());
                arrayCallback.sukses(show);
            }
        });
    ...
    public void loadDetailMovie(String language, String page, final DetailMovieRemoteDataSource.CallbackDetailMovie arrayCallback){
        ...
        Call<com.stackanswer.retrofit.detailmovie.Response> client = ApiConfig.getApiService().getDetailMoviePopuler(page, API_KEY_MOVIEDB, language);
        client.enqueue(new Callback<com.stackanswer.retrofit.detailmovie.Response>() {
            @Override
            public void onResponse(@NotNull Call<com.stackanswer.retrofit.detailmovie.Response> call, @NotNull Response<com.stackanswer.retrofit.detailmovie.Response> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        com.stackanswer.retrofit.detailmovie.Response data = response.body();
            ...
            @Override
            public void onFailure(@NotNull Call<com.stackanswer.retrofit.detailmovie.Response> call, @NotNull Throwable t) {
                Log.e(TAG, "onFailure: " + t.getMessage());
                arrayCallback.sukses(movie);
            }
        });
